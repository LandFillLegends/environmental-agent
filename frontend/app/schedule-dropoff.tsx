...
export default function ScheduleScreen() {
  ...
  useEffect(() => {
    ...
    getSuggestedSlots(facility.name, facility.address, wasteItem, userTimezone)
      .then((res) => {
  ...
  const handleConfirm = async () => {
    ...
    setConfirming(true);
    try {
      await scheduleDisposal(facility.name, facility.address, slot.date, slot.time, wasteItem, userTimezone);
